...
import heroImg from "../../assets/service-time/hero-service-time.png";
import feature1Img from "../../assets/service-time/feature-1.png";
import feature2Img from "../../assets/service-time/feature-2.png";
import feature3Img from "../../assets/service-time/feature-3.png";
import feature4Img from "../../assets/service-time/feature-4.png";
...
const FEATURES = [
  {
    img: feature1Img,
    title: "Auto-Track Every Session Effortlessly",
    desc: "AbleSpace automatically logs service time as you work — no manual entry, no missed minutes, no compliance gaps.",
    bullets: [
      "Smart attendance detection per session",
      "Customizable session types and durations",
      "Automatically synced across your team",
      "Works with any schedule or rotation",
    ],
  },
  {
    img: feature4Img,
    title: "Instant Billing-Ready Session Notes",
    desc: "Every session generates a compliant billing note automatically — ready for Medicaid or insurance submission with zero extra work.",
    bullets: [
      "Auto-generated notes after every session",
      "Meets Medicaid documentation standards",
      "Export to PDF, CSV, or billing platform",
      "Saves 3+ hours per provider per week",
    ],
  },
];
...
const CARDS = [
  {
    img: feature2Img,
    label: "SESSION LOGS",
    title: "Complete history, always accessible",
    desc: "Every session is logged and searchable. Pull up any student's full service history in seconds — no digging through paper files.",
    cta: "Session Logs",
  },
  {
    img: feature3Img,
    label: "MANDATED MINUTES",
    title: "Stay on top of every required minute",
    desc: "Real-time tracker shows exactly where each student stands on their mandated service minutes across all IEP service types.",
    cta: "Mandated Minutes",
  },
];
      ...
      >
        <div style={{
          ...
          <h1 style={{
            ...
            <span style={{ display: "block" }}>that runs itself.</span>
          </h1>
          ...
          <p style={{
            ...
            Auto-track sessions, monitor mandated minutes, and generate
            billing-ready notes — all without lifting a finger.
          </p>
        ...
        <div style={{ marginTop: 96, width: "100%", position: "relative" }}>
          <div style={{
            ...
            <div style={{ display: "block", lineHeight: 0 }}>
              <img
                src={heroImg}
                alt="AbleSpace Service Time dashboard"
