...
const STATS = [
  { value: "10+", label: "Roles supported" },
  { value: "Real-time", label: "Updates across all devices" },
  { value: "100%", label: "FERPA-compliant sharing" },
  { value: "3×", label: "Fewer communication gaps" },
];
...
const FEATURES = [
  {
    ...
    desc: "Assign roles with granular permissions — providers see their caseload, admins see everything, parents see their child.",
    tags: ["Permissions","Security","Roles"],
  },
  {
    emoji: "💬",
    title: "In-App Messaging",
    desc: "Communicate about students directly in context — attach data, notes, or files without leaving AbleSpace.",
    tags: ["Messaging","Context","Files"],
  },
  {
    emoji: "📣",
    title: "Smart Notifications",
    desc: "Automatic alerts when a goal is updated, a session is logged, or an IEP deadline is approaching.",
    tags: ["Alerts","Real-time","Deadlines"],
  },
  {
    emoji: "🏫",
    title: "District Admin View",
    desc: "Administrators get a bird's-eye view of every school, caseload, and compliance metric in the district.",
    tags: ["Admin","District","Oversight"],
  },
  {
    emoji: "👨‍👩‍👧",
    title: "Parent Portal",
    desc: "Parents can view their child's progress, upcoming sessions, and IEP status in a secure, read-only portal.",
    tags: ["Parents","Transparency","FERPA"],
  },
  {
    emoji: "🔗",
    title: "Integration Ready",
    desc: "Connect AbleSpace with your existing SIS, Google Workspace, or Microsoft 365 for seamless data flow.",
    tags: ["SIS","Google","Microsoft"],
  },
];
...
const STEPS = [
  {
    ...
    desc: "Add providers, teachers, administrators, and parents. Assign roles in seconds — everyone gets the right level of access.",
  },
  {
    num: "02",
    title: "Collaborate in context",
    desc: "Comment on sessions, tag teammates, and share updates directly on student records.",
  },
  {
    num: "03",
    title: "Stay in sync",
    desc: "Real-time notifications keep everyone aligned — no more lost emails or missed updates about your students.",
  },
];
      ...
      <section style={{
        ...
        >
          ...
          <h1 style={{
            ...
            Your whole team,<br />on the same page.
          </h1>
          ...
          <p style={{
            ...
            AbleSpace connects every member of the special ed team — therapists, teachers, administrators, and parents — with role-based access and real-time updates.
          </p>
      ...
      <div style={{ background: "#fff", borderTop: "1px solid rgba(0,0,0,0.06)", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
        ...
        >
          {STATS.map((s, i) => (
            ...
            >
              <div style={{ fontFamily: SERIF, fontWeight: 400, fontSize: isMobile ? 28 : 36, color: DARK, lineHeight: 1 }}>
                {s.value}
              </div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={features.ref}>
            ...
            <h2 style={{
              ...
              Built for every role<br />on the special ed team.
            </h2>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div ref={steps.ref}>
            ...
            <h2 style={{
              ...
              Get your whole team<br />connected in minutes.
            </h2>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h2 style={{
              ...
              Bring your whole team<br />to AbleSpace.
            </h2>
            ...
            <p style={{
              ...
              From the SLP to the superintendent — every role, every school, one shared source of truth.
            </p>
