...
import heroImg from "../../assets/iep-audit/hero/Frame 48098861.png";
import feature1Img from "../../assets/iep-audit/feature-1.png";
import feature2Img from "../../assets/iep-audit/feature-2.png";
...
const FEATURES = [
  {
    img: feature1Img,
    title: "Tailored Compliance for Your Workflow",
    desc: "Easily add, edit, and prioritize custom audit rules to match your school or district's unique requirements.",
    bullets: [
      "Create custom rules for specific audit criteria",
      "Edit or update existing rules anytime",
      "Set rule priority (High, Medium, Low)",
      "Maintain consistent compliance across all IEPs",
    ],
  },
  {
    img: feature2Img,
    title: "Real-Time Goal Progress Tracking",
    desc: "Log data after every session and watch progress update instantly. AbleSpace flags stalled goals before they become compliance issues.",
    bullets: [
      "Track annual goals, objectives, and benchmarks",
      "Automatic progress calculations per trial",
  ...
  },
  {
    ...
    bullets: [
      "20+ pre-built report formats for IEP meetings",
      "Export to PDF, CSV, or print directly",
      ...
      >
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            <span style={{ display: "block" }}>that actually works.</span>
          </h1>
          ...
          <p style={{
            ...
            Track every IEP goal, catch compliance gaps before audits, and generate
            audit-ready reports in one click — all in AbleSpace.
          </p>
        ...
        <div style={{ marginTop: 96, width: "100%", position: "relative" }}>
          <div style={{
            ...
            <div style={{ display: "block", lineHeight: 0 }}>
              <img
                src={heroImg}
                alt="AbleSpace IEP Audit dashboard"
